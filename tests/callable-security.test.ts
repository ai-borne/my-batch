...
const callableExports = [
  'addArchiveMedia', 'approveMembership', 'assignCoordinator', 'attachExpenseReceipt', 'attachPaymentEvidence', 'bootstrapCoordinator', 'listBootstrapCandidates', 'listDirectory', 'listGovernanceAuditEvents', 'listGovernanceMembers',
