export const COPY = {
  ...
  account: {
    eyebrow: 'Account',
    title: 'Your profile',
    intro: 'Visible only to approved batch members.',
    preview: 'Preview my profile',
    saved: 'Profile saved.',
    identity: 'Identity',
    identityHint: 'Your name, photo, and city tell batchmates who you are.',
    life: 'Professional and life details',
    schoolMemories: 'School memories',
    memoriesLabel: 'Shared memories',
    memoriesCount: (count: number) => `You have shared ${count} memories.`,
    viewMemories: 'View all memories',
    appearance: 'Appearance',
    themeLabel: 'Theme',
    links: 'Links',
    privacySupport: 'Privacy and support',
    privacyBody: 'Directory, profile, and RSVP information are private to approved batch members. You can request a correction or deletion of your profile data.',
    requestCorrection: 'Request correction',
    requestDeletion: 'Request deletion',
    contactCoordinator: 'Contact Coordinator on WhatsApp',
    danger: 'Danger zone',
    dangerHint: 'These actions are permanent. A Coordinator must confirm before changes take effect.',
    save: 'Save profile',
    saveDirty: 'Save profile',
    unsaved: 'You have unsaved changes. Save or discard them before leaving.',
    coordinatorTools: 'Coordinator tools',
    openCoordinatorTools: 'Open Coordinator tools',
  },
  directory: {
