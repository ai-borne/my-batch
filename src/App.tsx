...
export default function App() {
  return <Suspense fallback={<main className="auth-card" role="status">Loading secure screen…</main>}><Routes><Route path="/" element={<Landing />} /><Route path="/request-access" element={<SignedInOnly><AccessRequest /></SignedInOnly>} /><Route path="/pending" element={<SignedInOnly><Pending /></SignedInOnly>} /><Route path="/access-denied" element={<SignedInOnly><Denied /></SignedInOnly>} /><Route element={<Protected />}><Route path="/home" element={<HomePage />} /><Route path="/houses" element={<HousesPage />} /><Route path="/reunion" element={<ReunionPage />} /><Route path="/reunion/fund" element={<FinancePage />} /><Route path="/memories" element={<MemoriesPage />} /><Route path="/account" element={<ProfilePage />} /><Route path="/account/coordinator" element={<CoordinatorOnly />} /><Route path="/fund" element={<Navigate to="/reunion/fund" replace />} /><Route path="/admin" element={<Navigate to="/account/coordinator" replace />} /></Route><Route path="*" element={<Navigate to="/" replace />} /></Routes></Suspense>
}
