...
export function CoordinatorPage() {
  ...
  async function loadMore(name: PageName) {
  ...
  async function submitDialog(values: FormData) {
    ...
    } catch (error) { throw error instanceof Error ? error : new Error('Unable to update membership.') }
  }
